	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'neon-pulse': {
					'0%, 100%': { 
						textShadow: '0 0 5px hsl(195, 100%, 50%), 0 0 10px hsl(195, 100%, 50%), 0 0 15px hsl(195, 100%, 50%)' 
					},
					'50%': { 
						textShadow: '0 0 2px hsl(195, 100%, 50%), 0 0 5px hsl(195, 100%, 50%), 0 0 8px hsl(195, 100%, 50%)' 
					}
				},
				'float': {
